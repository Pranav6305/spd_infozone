...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(7,'members','student'),(6,'sessions','session');
...
--
-- Table structure for table `members_student`
--

DROP TABLE IF EXISTS `members_student`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `members_student` (
...
--
-- Dumping data for table `members_student`
--
...
--
-- Table structure for table `temp_members_student`
--

DROP TABLE IF EXISTS `temp_members_student`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `temp_members_student` (
...
--
-- Dumping data for table `temp_members_student`
--

LOCK TABLES `temp_members_student` WRITE;
/*!40000 ALTER TABLE `temp_members_student` DISABLE KEYS */;
INSERT INTO `temp_members_student` VALUES ('22z207','Ajay S','BE CSE','Kerala','123456\r'),('22z263','SriHari','BE CSE','Erode','8344343143\r');
/*!40000 ALTER TABLE `temp_members_student` ENABLE KEYS */;
UNLOCK TABLES;
